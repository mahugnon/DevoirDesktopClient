 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://services.mspi.issatso.org/", wsdlLocation = "http://localhost:8096/devoirSoap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://services.mspi.issatso.org/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8096/devoirSoap?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://services.mspi.issatso.org/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.mspi.issatso.org/", "SoapServicePort"), SoapService.class, features);
    }
